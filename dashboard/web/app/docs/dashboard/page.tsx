...
const ORB_LEGEND: { n: number; title: string; body: React.ReactNode }[] = [
  ...
  { n: 5, title: "Consensus dots + tally", body: "One dot per active model, lit green/red by its vote and unlit when FLAT. “1L · 0S · 5F · 1/6” = one long vote, zero short, five abstaining, agreement 1 of 6." },
